...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_simple_sin')) {
        Object.defineProperty(Module['ready'], '_simple_sin', { configurable: true, get: function() { abort('You are getting _simple_sin on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_simple_sin', { configurable: true, set: function() { abort('You are setting _simple_sin on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _simple_sin = Module["_simple_sin"] = createExportWrapper("simple_sin");
